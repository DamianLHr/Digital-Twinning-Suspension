...
namespace Suspension.Model
{
    ...
    /// subclassed) and exposes the quantities the IMU / potentiometer read.
    ///
    ...
    public class SprungMass : MonoBehaviour
    {
        ...
        public Vector3 GetAcceleration()    => _acceleration;        // proper accel, matches real IMU
        public Vector3 GetAngularVelocity() => rb.angularVelocity;   // rad/s
    }
}
